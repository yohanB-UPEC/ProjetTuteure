...
QT_MOC_LITERAL(3, 29, 8), // "validate"
QT_MOC_LITERAL(4, 38, 13), // "createProject"
QT_MOC_LITERAL(5, 52, 18), // "caracteresSpeciaux"
QT_MOC_LITERAL(6, 71, 9) // "isExisted"

    },
    "ProjectController\0parcourir\0\0validate\0"
    "createProject\0caracteresSpeciaux\0"
    "isExisted"
};
...
void ProjectController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: { bool _r = _t->caracteresSpeciaux();
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 4: { bool _r = _t->isExisted();
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
    }
