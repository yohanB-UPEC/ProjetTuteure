...
QT_MOC_LITERAL(3, 17, 5) // "suppr"

    },
    "TreeItem\0rename\0\0suppr"
};
...
void TreeItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->suppr(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (TreeItem::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TreeItem::rename)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TreeItem::suppr)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void TreeItem::rename(QString _t1)
{
