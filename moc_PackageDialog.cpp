...
struct qt_meta_stringdata_PackageDialog_t {
    QByteArrayData data[7];
    char stringdata0[72];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PackageDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_PackageDialog_t qt_meta_stringdata_PackageDialog = {
    {
QT_MOC_LITERAL(0, 0, 13), // "PackageDialog"
QT_MOC_LITERAL(1, 14, 8), // "validate"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 12), // "selectedItem"
QT_MOC_LITERAL(4, 37, 14), // "QItemSelection"
QT_MOC_LITERAL(5, 52, 8), // "selected"
QT_MOC_LITERAL(6, 61, 10) // "deselected"

    },
    "PackageDialog\0validate\0\0selectedItem\0"
...
void PackageDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PackageDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject PackageDialog::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_PackageDialog.data,
    qt_meta_data_PackageDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *PackageDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PackageDialog.stringdata0))
