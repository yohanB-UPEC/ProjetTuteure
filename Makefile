#############################################################################
# Makefile for building: my_app_test
# Generated by qmake (3.1) (Qt 5.12.11)
# Project:  projet.pro
# Template: app
# Command: C:\qt5-build\qtbase\bin\qmake.exe -o Makefile projet.pro -config test_conf
#############################################################################
...
Makefile: projet.pro C:/qt5/qtbase/mkspecs/win32-g++/qmake.conf C:/qt5/qtbase/mkspecs/features/spec_pre.prf \
		...
		C:/qt5/qtbase/mkspecs/features/testlib_defines.prf \
		...
		C:/qt5-build/qtbase/lib/Qt5Test.prl \
		C:/qt5-build/qtbase/lib/Qt5Core.prl
	$(QMAKE) -o Makefile projet.pro -config test_conf
