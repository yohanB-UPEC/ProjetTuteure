/****************************************************************************
** Meta object code from reading C++ file 'InterfaceDialog.h'
**
...
#error "The header file 'InterfaceDialog.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_InterfaceDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_InterfaceDialog_t qt_meta_stringdata_InterfaceDialog = {
    {
QT_MOC_LITERAL(0, 0, 15), // "InterfaceDialog"
QT_MOC_LITERAL(1, 16, 8), // "validate"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 9), // "parcourir"
QT_MOC_LITERAL(4, 36, 10) // "parcourir2"

    },
    "InterfaceDialog\0validate\0\0parcourir\0"
    "parcourir2"
};
...
void InterfaceDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<InterfaceDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject InterfaceDialog::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_InterfaceDialog.data,
